...
export class Architect implements Employee {
    ...
    constructor() {
        ...
        (this.name = "John Doe"), (this.email = "j@d");
...
export class Developer implements Employee {
    ...
    constructor() {
        ...
        (this.name = "Robin Hood"), (this.email = "r@h");
        this.occupation = this.designation;
    }
}
...
export class FictionAuthor implements Author {
    ...
    occupation: string;
    constructor() {
        (this.name = "JK Rowling"), (this.email = "jk@r");
        this.publications = [
            {
...
export function logPerson(person: Person) {
    console.log(
        `Name: ${person.name} is ${person.occupation}, can be reached at ${person.email}`
    );
}
...
export function logAuthor(author: Author) {
    ...
    author.publications.forEach((book) =>
        console.log(
            `Title: ${
                book.title
            }, Puplished at: ${book.pubDate.toLocaleDateString()})`
        )
    );
}
